...
import { Home, Camera, FileText, Calendar, DollarSign } from "lucide-react";
...
export default function ClientPortalLayout() {
  ...
  const menuItems = [
    { label: "Inicio", icon: Home, href: "/portal" },
    { label: "Avances", icon: Camera, href: "/portal/avances" },
    { label: "Docs", icon: FileText, href: "/portal/documentos" },
    { label: "Citas", icon: Calendar, href: "/portal/citas" },
    { label: "Presup.", icon: DollarSign, href: "/portal/presupuesto" },
  ];
